...
const Game = () => {
    ...
    const handleEasterEgg = (e) => {
        e.preventDefault();
        window.alert('You have found an easter egg!');
    }
    return (
        <svg viewBox="0 0 227.04 281.05" className={classes.svgm}>
            <g data-name="Layer 2">
                <g data-name="Layer 1">
                    <path
                    ...
                    <path id={classes.easter1} onClick={handleEasterEgg}
                    ...
                    <path d="M108.1,73.54v-9H80.35a54.74,54.74,0,0,1,1.59,9Z" />
                    <path d="M108.1,145.54v-9H74.88a44.38,44.38,0,0,1,4.3,9Z" />
                    <path d="M108.1,217.54v-9H68.67c-.46,3.07-.83,6.07-1,9Z" />
                    <path
                    ...
                    <path d="M117.1,217.54h40.47c-.21-2.93-.58-5.93-1-9H117.1Z" />
                    <path d="M117.1,64.54v9h26.16a54.74,54.74,0,0,1,1.59-9Z" />
                    <path d="M117.1,145.54H146a44.38,44.38,0,0,1,4.3-9H117.1Z" />
                </g>
            </g>
        </svg>
    )
