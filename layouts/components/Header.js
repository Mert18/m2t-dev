  ...
  return (
    <header className={classes.header}>
      ...
      <nav className={classes.header__nav}>
        ...
        <div
          className={
            router.pathname === "/projects" ? classes.active : classes.linkbox
          }
        >
        ...
        <div
          className={
            router.pathname === "/comics" ? classes.active : classes.linkbox
          }
        >
