...
In this blog post. I will explain you **getStaticPaths**, **getStaticProps** and using external sources on this functions. So you will not be having hard time using them 🙂.
