...
<Prompt>
  <p>
    I am a software enginner and I have been developing web applications in
    frontend and backend for 3 years. Now I want to learn what Kubernetes is. I
    have heard of it many times, but it is just a fuzzy knowledge that I have.
    First of all, I want to start from the beginning. Kubernetes and Cloud are
    two words that is used always together. What is "Cloud"? Is it really just
