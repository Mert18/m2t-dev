...
image: /posts/monitoring-a-docker-spring-boot-application/monitoring.png
---
...
<BlogImage source={"/posts/monitoring-a-docker-spring-boot-application/docker-instances-running.png"} description={"terminal showing docker instances running"} />
...
<BlogImage source={"/posts/monitoring-a-docker-spring-boot-application/prometheus-ui.png"} description={"prometheus ui running two instances running"} />
...
<BlogImage source={"/posts/monitoring-a-docker-spring-boot-application/grafana-dashboard.png"} description={"grafana dashboard seems working"} />