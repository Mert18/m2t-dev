...
image: https://m2t-dev-static.fra1.digitaloceanspaces.com/posts/monitoring-a-dockerized-spring-boot-application/monitoring.png
---
...
<BlogImage source={"https://m2t-dev-static.fra1.digitaloceanspaces.com/posts/monitoring-a-dockerized-spring-boot-application/docker-instances-running.png"} description={"terminal showing docker instances running"} />
...
<BlogImage source={"https://m2t-dev-static.fra1.digitaloceanspaces.com/posts/monitoring-a-dockerized-spring-boot-application/prometheus-ui.png"} description={"prometheus ui running two instances running"} />
...
<BlogImage source={"https://m2t-dev-static.fra1.digitaloceanspaces.com/posts/monitoring-a-dockerized-spring-boot-application/grafana-dashboard.png"} description={"grafana dashboard seems working"} />