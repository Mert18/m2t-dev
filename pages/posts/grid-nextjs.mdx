---
title: "Making Photo Gallery in Next.js With CSS Grid"
description: "Digging into CSS Grid and Next.js Image component."
date: "24 July, 2021"
layout: "post"
---

import classes from "../../styles/mdx.module.css";

<h2 className={classes.head2}>Introduction</h2>
<br />
...
<h2 className={classes.head2}>Final Project</h2>
<br />
<img src="/images/posts/image-grid/image-grid.gif" width="100%" />
<br />

<br />
<h2 className={classes.head2}>TLDR</h2>
<br />
...
<h2 className={classes.head2}>CSS Grid Introduction</h2>
<br />
...
be found <span className={classes.link}>[**here**](https://css-tricks.com/snippets/css/complete-guide-grid/)</span>. I definitely recommend it. But today, I am going to talk about the
...
```css
grid-template-columns(rows): 1fr 1fr 1fr;
```
...
```CSS
grid-template-columns (rows): repeat(24, 1fr);
```
...
<h2 className={classes.head2}>Next.js Images</h2>
<br />
...
information about the Image component in <span className={classes.link}>[NextJS Image Docs](https://nextjs.org/docs/api-reference/next/image)</span>
...
Layout property is instrinsic as default. It makes the images resize as the
...
functionality with CSS object-fit. You can see different variations in <span className={classes.link}>[Mozilla CDN Docs](https://developer.mozilla.org/en-US/docs/Web/CSS/object-fit)</span>. We are going to use cover
...
Next.js Image component requires width and height properties as default. But
...
<h2 className={classes.head2}>Making The Project</h2>
<br />
...
Of course, you can add more images or give it a completely new look. Please
resize the project and see the change and decide if it is what you want.
